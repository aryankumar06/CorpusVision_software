...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <StatsCard
          title="Total Businesses registered"
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <h3 className="font-semibold">Run Data Scraper</h3>
            <p className="text-sm opacity-90">Extract latest order data</p>
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.02, y: -2 }}
            whileTap={{ scale: 0.98 }}
          ...
          >
            ...
            <p className="text-sm opacity-90">Detailed business insight</p>
          </motion.button>
        </div>
      </motion.div>
    </div>
